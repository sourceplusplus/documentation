...
```
CATALINA_OPTS="$CATALINA_OPTS -javaagent:<install_dir>/spp-probe-0.1.19.jar"; export CATALINA_OPTS
```
...
```
set "CATALINA_OPTS=-javaagent:<install_dir>/spp-probe-0.1.19.jar"
```
